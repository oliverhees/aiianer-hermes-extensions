...
echo "  2. Einen Gruppenchat oeffnen - oben in der Kopfzeile steht jetzt das Budget,"
echo "     z.B. \"3 rounds - 10 msgs\". Ein Klick darauf oeffnet die Einstellungen."
echo "  3. Beim Anlegen eines neuen Gruppenchats gibt es \"Room budget\" zum Aufklappen."
echo ""
